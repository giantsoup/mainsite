...
function createParticipant() {
    form.patch(route('participants.update', [props.participant.id]));
}
</script>
                    ...
                    <form @submit.prevent="createParticipant" class="max-w-lg">
                        <div class="p-6 text-gray-900 dark:text-gray-100">
                            <div class="mb-4">
                                ...
                                <PrimaryButton type="submit" class="mt-4" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">Update Participant</PrimaryButton>
                            </div>
                        </div>
                    </form>
                </div>
